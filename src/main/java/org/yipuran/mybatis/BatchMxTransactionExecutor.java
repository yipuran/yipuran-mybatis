...
/**
 * BATCH処理用複数ＤＢトランザクション インターセプター
 */
public class BatchMxTransactionExecutor implements MethodInterceptor{
	...
	public Object invoke(MethodInvocation m) throws Throwable{
		...
		try{
			for(String key : this.factorymap.keySet()){
				sessionmap.put(key, this.factorymap.get(key).openSession(ExecutorType.BATCH, false));
			}
